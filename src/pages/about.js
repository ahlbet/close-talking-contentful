    ...
    <div className="about">
      ...
      <div className="about__jack">
        <p className="about__jack--text">
          <b>Jack Rossiter-Munley</b> is a freelance writer, editor, and
          podcaster. His poetry and nonfiction have been published in{" "}
          <em>The Ekphrastic Review</em>, <em>Barren Magazine</em>, and{" "}
          <em>One Week//One Band</em> among others, and he writes about
          professional tennis and politics for <em>Last Word on Sports</em>,{" "}
          <em>Sports and Politics</em>, and the{" "}
          <em>Deep State Radio Network</em>. In addition to co-hosting Close
          Talking, he produces Poetry Spoken Here, a poetry interview podcast
          recently named one of the “Best Poetry Podcasts of 2018” by Playerfm,
          and is the host of the New Books in National Security podcast for the
          New Books Network. The music heard at the beginning and end of every
          Close Talking episode is composed and performed by Jack.
        </p>
        <img
          src={jackImage}
